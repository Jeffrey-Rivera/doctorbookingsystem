...
const SpecialityMenu = () => {
  return (
    <div className='flex flex-col items-center gap-4 py-16 text-gray-600' id='speciality'>
      ...
      <p className='sm:w-1/3 text-center text-sm'>Browse and Request your appointment now.</p>
      <div className='flex sm:justify-center gap-4 pt-5 w-full overflow-x-hidden'> {/* Removed overflow-scroll and added overflow-x-hidden */}
