            ...
            <div className='flex items-center gap-4'>
                {
                    token && userData
                        ...
                        : <button onClick={() => navigate('/login')} className='bg-primary text-white px-8 py-3 rounded-full font-light hidden md:block hover:bg-primary-light'>Create account</button>
                }
            </div>
        </div>
    )
