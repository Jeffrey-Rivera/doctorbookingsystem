        ...
        <div className='min-h-screen bg-white border-r'>
            {
                aToken && <ul className='text-[#515151] mt-5'>
                    ...
                    <NavLink to={'/admin-careers'} className={({ isActive }) => `flex items-center gap-3 py-3.5 px-3 md:px-9 ${isActive ? 'bg-[#F2F3FF] border-r-4 border-primary' : ''}`}>
                        <img src={assets.careers_icon} alt='' />
